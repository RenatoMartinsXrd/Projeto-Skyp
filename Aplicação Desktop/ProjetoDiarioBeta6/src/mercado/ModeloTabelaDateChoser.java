...
public final class ModeloTabelaDateChoser extends AbstractTableModel{
    
     private ArrayList linhas= null;
     private String [] colunas = null;
 
 public ModeloTabelaDateChoser (ArrayList lin, String[] col){
     setLinhas (lin);
     setColunas(col);
 }
                ...
                switch (column) {
                    case 2://como só tem uma coluna eu deixei default
                         getValueAt(2, column).getClass();
                          type = new JDateChooser().getClass();
                    break;
