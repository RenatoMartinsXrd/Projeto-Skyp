 ...
 * @author Scarlxrd2112
 */
public class JanelaLousa extends javax.swing.JDialog {
     ...
     * @param t
     */
    public JanelaLousa(ArrayList<Double> j,ArrayList<String> t) {
...
jScrollPane3.getViewport().setOpaque(false);
   ...
   jScrollPane3.setBackground(converteRGB(hex));
...
String sb = hex.substring(4,6);
    ...
    public void preencher(ArrayList<Double> j,ArrayList<String> t){
       
                 String [] colunas = new String[]{"Avaliações","Notas"};
...
headerRenderer.setBackground(converteRGB("13CE66"));
 ...
 jTable2.getColumnModel().getColumn(0).setPreferredWidth(100);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Notas das Avaliações");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaLousa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ArrayList<Double> j = null;
ArrayList<String> t = null;
                JanelaLousa dialog = new JanelaLousa(j, t);
