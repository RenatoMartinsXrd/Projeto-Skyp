 ...
 * @author Scarlxrd2112
 */
public class ConteudoProgramaticoREST {
    
     private final String USER_AGENT = "Mozilla/5.0";
      
      
      public void Salvar(ConteudoProgramatico u) throws Exception {
       String url =  "http://localhost:8085/WebServiceDiarioTom/webresources/generic/Conteudo_Programatico/inserir/";
    ...
    URI uri = new URI(url1.getProtocol(), url1.getUserInfo(), url1.getHost(), url1.getPort(), url1.getPath(), url1.getQuery(), url1.getRef());
      ...
      Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
          Type usuarioType =  new TypeToken<ConteudoProgramatico>(){}.getType();
