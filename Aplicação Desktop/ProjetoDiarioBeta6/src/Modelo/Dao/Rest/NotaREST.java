...
public class NotaREST {
      ...
      public boolean Salvar(Nota u) throws Exception {
          boolean retornar = false;
       String url =  "http://localhost:8085/WebServiceDiarioTom/webresources/generic/Nota/inserir/";
        URL obj = new URL(url);
      ...
      Gson gson = new Gson();
          Type usuarioType =  new TypeToken<Nota>(){}.getType();
